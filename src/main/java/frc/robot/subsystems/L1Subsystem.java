...
public class L1Subsystem extends SubsystemBase {
    ...
    public L1Subsystem(){
        ...
        .outputRange(-0.1,0.1)//determines the speeeeed limit. L1 TODO - this will likely need to be raised before tuning
        .maxMotion
        .maxAcceleration(0)
        .maxVelocity(0) //I saw in the documentation that this is getting replaced with cruiseVelocity
        .allowedClosedLoopError(0.1);//TODO: Tune this L1 TODO - is this in degrees?
